function guineaPig(input) {
    ...
    if(isAllEnough) {
        console.log(`Everything is fine! Puppy is happy! Food: ${(quantityOFFoodsInGrams / 1000).toFixed(2)}, Hay: ${(hayInGrams / 1000).toFixed(2)}, Cover: ${(coverInGrams / 1000).toFixed(2)}."`)
    }
